package businessdirt.factorygame.core.config.gui.components;

import businessdirt.factorygame.FactoryGame;
import businessdirt.factorygame.core.config.data.PropertyData;
import businessdirt.factorygame.core.config.gui.SettingsGui;
...
public class ColorComponent extends GuiComponent {
    ...
    public static class ColorPicker extends GuiComponent {
        ...
        private ColorPicker(Skin skin) {
            ...
            this.colorWheel = new Image(FactoryGame.assets.getTexture("textures/gui/settings/colorwheel.png"));
