...
import businessdirt.factorygame.core.config.gui.components.ColorComponent;
...
public class SettingsScreen extends AbstractScreen {
    ...
    public SettingsScreen() {
        super(FactoryGame.assets.getSkin("skins/settings/skin.json"), Color.TEAL);
    }
    ...
    public void show() {
        ...
        backButton.addListener(new ChangeListener() {
            @Override
            public void changed(ChangeEvent event, Actor actor) {
                FactoryGame.get().setScreen(new MenuScreen());
            }
        });
