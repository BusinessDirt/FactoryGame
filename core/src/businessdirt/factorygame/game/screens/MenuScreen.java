...
public class MenuScreen extends AbstractScreen {
    ...
    public MenuScreen() {
        super(FactoryGame.assets.getSkin("skins/mainmenu/skin.json"), Color.TEAL);
    }
    ...
    public void show() {
        ...
        settingsButton.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                FactoryGame.get().setScreen(new SettingsScreen());
            }
        });
        ...
        playButton.addListener(new ChangeListener() {
            @Override
            public void changed(ChangeEvent event, Actor actor) {
                FactoryGame.get().setScreen(new GameScreen());
            }
        });
